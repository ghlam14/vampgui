...
[VAMPIRE - Atomistic Spin Dynamics](https://vampire.york.ac.uk/)
...
atomistic spin dynamics code. The GUI has been tested on Linux systems including **Ubuntu 20.04** and **Ubuntu 24.04**.
...
Experimental feature: Convert CIF files to .ufc format using pymatgen (under testing and improvement).
